...
import HgncVegaGeneView from './../../view/gene/hgnc-vega';
import HgncVegaGeneModel from './../../model/gene/hgnc-vega';
import { Bump } from './../../../interfaces/gene';
import * as $ from '../../../../node_modules/jquery/dist/jquery.js';

export default class HgncVegaGeneTrack extends GeneTrack {
  ...
  public static Name: string = 'HGNC Vega Genes';
    ...
    super(genoverse, {
      ...
      lengthDependentMV: [
        { // This one applies when > 2M base-pairs per screen
          minLength: 2000000,
          model: {
            class: HgncVegaGeneModel
          },
          view: {
            class: HgncVegaGeneView,
  ...
  populateMenu(feature: any) {
    const url  = 'http://vega.archive.ensembl.org/Homo_sapiens/Gene/Summary?db=core;g=' + feature.id;
